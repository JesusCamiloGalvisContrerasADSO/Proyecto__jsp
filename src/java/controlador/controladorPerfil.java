...
public class controladorPerfil extends HttpServlet {
    ...
    String add = "html/Perfil/add.jsp";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("listar")) {
            ...
            Date fechContrato = new Date();
            
            Tip.setNombre(nom);
            Tip.setApellido(apell);
            Tip.setTelefono(tel);
            Tip.setEmail(email);
            Tip.setTipoDocId(tipDoc);
            Tip.setSangreId(tipSang);
            Tip.setFechaContrato(fechContrato);
            dao.add(Tip);
            acceso = listar;
